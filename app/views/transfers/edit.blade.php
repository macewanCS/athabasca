...
<input type="submit" name="arrived"  value="Confirm Transfer Has Been Received" class = "createbook">
...
<input type="submit" name="intransit"  value="Confirm Transfer Has Been Sent" class = "createbook">
{{Form::close()}}
<hr class="divider">
